...
{
    public record DetailsCandidateUser: OwnerShipDataDto
    {
        ...
        public static explicit operator DetailsCandidateUser(CandidateUser item)
        {
            return new DetailsCandidateUser
            {
                Id = item.Id,
